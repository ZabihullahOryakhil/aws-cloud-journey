...
BUCKET=$1
REGION="us-east-1"
WORKDIR="$HOME/Desktop/cloud/aws-cloud-journey/02-independent-practice/test-files"
LOGFILE="$HOME/Desktop/aws-cloud-journey/02-independent-practice/s3_manager.log"
...
echo "S3 Manager run: $TIMSTAMP" > $LOGFILE
